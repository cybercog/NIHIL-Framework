...
<div id="site-wrapper">
			...
			<nav class="navbar navbar-inverse" role="navigation">
			  <div class="container-fluid">
				...
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="<?php echo \Yii::$app->urlManager->createUrl(['/']); ?>"><img alt="(+dR) Dead Rabbits" src="/img/logos/dead_rabbits_25x25.png" height="30px" style="margin-top:-5px;"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					<!--<li class="dropdown">
						<a href="<?php echo \Yii::$app->urlManager->createUrl(['bank']); ?>" class="dropdown-toggle" data-toggle="dropdown">Bank <span class="caret"></span></a>

					  <ul class="dropdown-menu" role="menu">
						<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank/alliance']); ?>">Alliance Bank</a></li>
						<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank/player']); ?>">Player Totals</a></li>
						<li class="divider"></li>
						<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank/create-transaction']); ?>">Create Transaction</a></li>
					...
					<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank']); ?>">Bank</a></li>
					<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['forums']); ?>">Forums</a></li>
				  </ul>
				  ...
				  <ul class="nav navbar-nav navbar-right">
					...
					echo '<!--<li><p class="navbar-text stone-text">Stone: 0</p></li>
						...
						echo '<li><a href="' . \Yii::$app->urlManager->createUrl(['login']) . '">Login</a></li>';
					    echo '<li><a href="' . \Yii::$app->urlManager->createUrl(['register']) . '">Register</a></li>';
					}
				  ?>
				  <li><a href="<?php echo \Yii::$app->urlManager->createUrl(['contact']); ?>"><i class="fa fa-question-circle"></i></a></li>
				  </ul>
				</div><!-- /.navbar-collapse -->
			  </div><!-- /.container-fluid -->
			</nav>
          ...
          <div class="row">
		    <div class="col-sm-3 col-md-2" id="site-content-left">
			  ...
			  <ul class="nav nav-sidebar">
				<li><h4>Bank Information</h4></li>
				<li class="active"><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank']); ?>">Overview <span class="sr-only">(current)</span></a></li>
				<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['bank/balance']); ?>">My Balance</a></li>
			  </ul>
			  
			  <?php if(Yii::$app->user->can('banker')) {
					echo '<ul class="nav nav-sidebar">
				<li><h4>Administration</h4></li>
				<li><a href="' . \Yii::$app->urlManager->createUrl(['players/manage']) . '">Manage Players</a></li>
				<li><a href="' . \Yii::$app->urlManager->createUrl(['bank/reconcile']) . '">Reconcile Accounts</a></li>
				</ul>';
			  } ?>
	...
	<footer id="site-footer">
      <div class="container-fluid">
	    <div class="row">
		  <div class="col-xs-6">
			<p class="visible-xs-inline">&copy;</p><p class="hidden-xs">Copyright &copy; <?php echo date("Y"); ?> Out of Morbid Curiosity.  All rights reserved.</p> <!--<a href="<?php echo \Yii::$app->urlManager->createUrl(['legal/privacy']); ?>">Privacy</a> <a href="<?php echo \Yii::$app->urlManager->createUrl(['legal/terms']); ?>">Terms</a>-->
		  </div>
		  <div class="col-xs-6 text-right">
		    Powered by <a href="http://www.nihil.co">NIHIL</a>
		  </div>
		</div>
	  </div>
	</div>
