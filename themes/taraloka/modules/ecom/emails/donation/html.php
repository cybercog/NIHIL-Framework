                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                                                                <tr>
                                                                    <td valign="top" style="color:#404040; font-family:Helvetica; font-size:16px; line-height:125%; text-align:Left; padding-bottom:20px;">
                                                                        <h3 style="margin:0; padding:0; color:#202020; font-family:Helvetica; font-size:20px; line-height:125%; text-align:Left;">Dear <?php echo $customer->first . ' ' . $customer->last; ?>,</h3>
                                                                        <br />
                                                                        On behalf of The Taraloka Foundation, I want to thank you for your donation. The following is a brief summary:<br /><br />
																		<strong>Donation Id:</strong> <code style="color:#afbd21;font-weight:bold;font-size:1.1em;"><?php echo $invoice->invoice_number; ?></code><br />
																		...
																		<strong>Card Number:</strong> <code style="color:#afbd21;font-weight:bold;font-size:1.1em;"><?php echo $payment->account_number; ?></code><br />
																		<strong>Designation:</strong> <code style="color:#afbd21;font-weight:bold;font-size:1.1em;">General Purpose</code><br /><br />
																		If you need any more information, or if you have any questions/concerns, you can contact me by replying to this email.
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
