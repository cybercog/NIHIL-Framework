...
$this->title = Yii::$app->params['siteMeta']['title'] . ' | Confirm Donation';
$this->params['breadcrumbs'][] = ['label' => 'Donate', 'url' => '/donate'];
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="row">
										...
										<div class="col-md-8">
											<small>Note: By pressing the following button, you will confirm your donation.  Please do not press back or refresh.</small>
										</div>
										<div class="col-md-4">
