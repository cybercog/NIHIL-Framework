                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                                                                <tr>
                                                                    <td valign="top" style="color:#404040; font-family:Helvetica; font-size:16px; line-height:125%; text-align:Left; padding-bottom:20px;">
                                                                        ...
                                                                        <br />
                                                                        Your password was successfully changed.  If you believe this to be an error, or if you need any more information, contact support immediately.
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <!-- // CONTENT TABLE -->
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
																<tr>
                                                                    ...
                                                                    <td valign="top" align="right" style="color:#FFFFFF; font-family:Helvetica; font-size:12px; line-height:125%; text-align:Right; padding-bottom:20px;">
																		 *You received this email because you changed your<br />password at <strong style="color:#afbd21;">The Taraloka Foundation</strong> online.
