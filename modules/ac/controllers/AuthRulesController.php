...
use app\modules\ac\models\search\AuthRuleSearch;
...
/**
 * AuthRulesController implements the CRUD actions for AuthRule model.
 */
class AuthRulesController extends Controller
{
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesIndex')) {
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesView')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
	...
	/**
     * Displays the details for a single AuthRule model.
     * @param string $id
     * @return mixed
     */
    public function actionDetails($id)
    {
		if (!\Yii::$app->user->can('acAuthRulesDetails')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesCreate')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesUpdate')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesDelete')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
    ...
    {
		if (!\Yii::$app->user->can('acAuthRulesList')) {
			if (!\Yii::$app->user->isGuest) {
				throw new ForbiddenHttpException('You do not have privileges to view this content.');
			}else{
				Yii::$app->session->setFlash('danger', 'You do not have privileges to view this content. Please login to continue.');
