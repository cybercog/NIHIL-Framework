...
/**
 * PasswordChangeSearch represents the model behind the search form about `app\modules\ac\models\PasswordChange`.
 */
class PasswordChangeSearch extends PasswordChange
{
    /**
     * @inheritdoc
     */
