...
use app\assets\NihilDashboardAsset;

/* @var $this \yii\web\View */
/* @var $content string */

NihilDashboardAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
			...
			<nav class="navbar navbar-inverse" role="navigation">
			  <div class="container-fluid">
				...
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="/"><img alt="The NIHIL Corporation" src="/img/logos/nihil-inverted_32x25.png"></a>
				</div>
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				  <ul class="nav navbar-nav">
					...
					<!--<li class="active"><a href="<?php echo \Yii::$app->urlManager->createUrl(['dashboard']); ?>">Dashboard</a></li>-->
				  </ul>
          ...
          <div class="row">
		    <div class="col-sm-3 col-md-2" id="site-content-left">
			  ...
			  <ul class="nav nav-sidebar">
				<li><h3>Domains</h3></li>
				<li class="active"><a href="<?php echo \Yii::$app->urlManager->createUrl(['domains/manage']); ?>">Manage <span class="sr-only">(current)</span></a></li>
				<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['domains/register']); ?>">Register</a></li>
				<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['domains/transfer']); ?>">Register</a></li>
			  </ul>
