...
use app\modules\pda\models\search\EmailSearch;
...
class EmailsController extends Controller
{
    ...
    {
		if(!$email = Email::find()->where(['token' => $token])->one()) {
			throw new NotFoundHttpException('The requested email does not exist.');
		}
