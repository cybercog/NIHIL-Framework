...
use app\modules\support\models\search\ForumPostsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ForumPostController implements the CRUD actions for ForumPost model.
 */
class ForumPostsController extends Controller
{
    ...
    {
        $searchModel = new ForumPostsSearch();
