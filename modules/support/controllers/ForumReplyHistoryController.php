...
use app\modules\support\models\search\ForumReplyHistorySearch;
 ...
 */
class ForumReplyHistoryController extends Controller
{
    ...
    {
        $searchModel = new ForumReplyHistorySearch();
