...
class CataloguesController extends Controller
{
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesIndex')) {
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesView')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesDetails')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesCreate')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesUpdate')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomCataloguesDelete')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
