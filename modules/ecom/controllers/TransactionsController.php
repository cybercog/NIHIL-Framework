...
use app\modules\ecom\models\search\TransactionSearch;
...
class TransactionsController extends Controller
{
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsIndex')) {
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsView')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsDetails')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsCreate')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsUpdate')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsDelete')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
    ...
    {
		if (!\Yii::$app->user->can('ecomTransactionsList')) {
			throw new ForbiddenHttpException('You do not have privileges to view this content.');
		}
