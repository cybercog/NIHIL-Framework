			...
			<nav class="navbar navbar-inverse" role="navigation">
			  <div class="container-fluid">
				...
				<div class="navbar-header">
				  ...
				  <a class="navbar-brand" href="<?php echo \Yii::$app->urlManager->createUrl(['gow']); ?>"><img alt="(+dR) Dead Rabbits" src="/img/logos/dead_rabbits_25x25.png"></a>
				</div>
          ...
          <div class="row">
		    <div class="col-sm-3 col-md-2" id="site-content-left">
			  ...
			  <ul class="nav nav-sidebar">
				...
				<li class="active"><a href="<?php echo \Yii::$app->urlManager->createUrl(['gow/bank']); ?>">Overview <span class="sr-only">(current)</span></a></li>
				<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['gow/bank/balance']); ?>">My Balance</a></li>
			  </ul>
			  
			  <?php if(Yii::$app->user->can('banker')) {
					echo '<ul class="nav nav-sidebar">
				<li><h4>Administration</h4></li>
				<li><a href="' . \Yii::$app->urlManager->createUrl(['gow/players/manage']) . '">Manage Players</a></li>
				<li><a href="' . \Yii::$app->urlManager->createUrl(['gow/bank/reconcile-accounts']) . '">Reconcile Accounts</a></li>
				</ul>';
			  } ?>
