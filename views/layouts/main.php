				...
				<ul class="list-inline pull-right">
				  ...
				  <?php 
					if(!Yii::$app->user->isGuest) {
						...
						<div class="btn-group">
						  <a href="#" class="btn btn-link dropdown-toggle" data-toggle="dropdown">
							Welcome ' . Yii::$app->user->identity->first_name . ' <span class="caret"></span>
						  </a>
						  <ul class="dropdown-menu" role="menu">
	      ...
	      <div class="row" id="site-footer-navigation">
		    <div class="col-sm-12">
			  ...
			  <div class="row">
				...
				<div class="col-sm-2 col-xs-4">
				  <h4><a href="<?php echo \Yii::$app->urlManager->createUrl(['services']); ?>">Services</a></h4>
				  <ul class="list-unstyled">
				...
				<div class="col-sm-2 col-xs-4">
				  ...
				  <ul class="list-unstyled">
					...
					<li><a href="<?php echo \Yii::$app->urlManager->createUrl(['company/data-centers']); ?>">Data Centers</a></li>
	  ...
	  <div class="container-fluid" id="site-footer-legal-wrapper">
	    <div class="container">
	      <div class="row" id="site-footer-legal">
		    <div class="col-sm-8" id="site-footer-legal-copyright">
		      Copyright &copy; 2010-<?php echo date("Y"); ?> The NIHIL Corporation.<br class="visible-xs-block" />  All rights reserved.<br class="visible-xs-block" /> <a href="<?php echo \Yii::$app->urlManager->createUrl(['legal/privacy-policy']); ?>">Privacy Policy</a> <a href="<?php echo \Yii::$app->urlManager->createUrl(['legal/terms-of-service']); ?>">Terms of Service</a>
		    </div>
		    <div class="col-sm-4 text-right" id="site-footer-legal-navigation">
